...
# rivet_analysis_dndxbdz_submit.sh
#
# Run the Rivet analysis EHIJING_SMASH_DNDXBDZ once per SMASH "profile_p_XXXXXX",
...
#
# Usage:
#   ./run_rivet_dndxbdz_per_profile.sh \
#     /path/to/output/runs/smash/events/ \
#     /path/to/output/runs/ehijing/DISKinematics.meta.jsonl \
#     /path/to/Rivet_EHIJING_SMASH_2026_DNDXBDZ.so \
#
# Examples:
#   bash run_rivet_dndxbdz_per_profile.sh output/runs/smash/events/ output/runs/ehijing/events/DISKinematics.meta.jsonl rivet/Rivet_EHIJING_SMASH_2026_DNDXBDZ.so
